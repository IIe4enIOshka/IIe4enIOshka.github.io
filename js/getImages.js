        ...
        success: function (data) {
            ...
            for(var index = 0; index < jsonData.length; index++)
            {
                ...
                if(jsonData[index].checking == 0){
                    $string = '<div class="image"><img class="like_click" src="' + window.location.origin + '/ico/heart/heart_disabled.png" alt=""></div>';
                }
                else{
                    $string = '<div class="image"><img class="like_click" src="' + window.location.origin + '/ico/heart/heart_enabled.png" alt=""></div>';
                }
